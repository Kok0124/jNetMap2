...
public class AboutDialog extends EscapableDialog implements HyperlinkListener {
    ...
    public AboutDialog(final Frame owner) {
        ...
        JLabel jNetMap = new JLabel("Version " + Controller.version, new ImageIcon(this.getClass().getResource("/img/splash-tb.png")), JLabel.CENTER);
    ...
    private static final String license = "<br>This program is free software; you can redistribute it and/or modify "
            ...
            + "<a href=\"http://www.gnu.org/licenses/gpl.html\">www.gnu.org/licenses/gpl.html</a><br><br>"
            + "The included libraries are published under their respective licenses, check the pom.xml for details.";
