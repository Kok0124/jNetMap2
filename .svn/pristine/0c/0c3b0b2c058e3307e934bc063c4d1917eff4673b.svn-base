...
public class AppearancePanel extends PreferencePanel {
    ...
    private JCheckBox deviceLabelName, deviceLabelDescription, deviceLabelLocation, deviceLabelVendor,
    ...
    public AppearancePanel(Window parent, Preferences preferences) {
        ...
        JPanel lafWrapper = new JPanel(new GridLayout(1, 2, 5, 5)) {{
            ...
            for (int i = 0; i < lafInfos.length; i++) lafClassNames[i] = lafInfos[i].getClassName();
            lafSelector = new JComboBox(lafClassNames);
        ...
        JPanel deviceWrapper = new JPanel(new GridLayout(3, 3, 5, 5)) {{
            ...
            deviceLabelDescription = new JCheckBox(Lang.get("device.description"), Settings.getBoolean("device.label.description", false));
