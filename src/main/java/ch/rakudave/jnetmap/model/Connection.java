...
public class Connection {
    ...
    public enum Type {
        Coaxial, Ethernet, Fiber, Phone, Serial, Tunnel, Wireless, Layer1, Layer2, Layer3, Layer4, Layer5, Layer6, Layer7, Layer_Vertical
        
    }

    public interface Protocoll {
        public enum Layer1_protocoll implements Protocoll {
            DSL, IDSN, USB, IrDA
        }
        public enum Layer2_protocoll implements Protocoll {
            CDP, Ethernet, STP, VTP, VLAN
        }
    }
    ...
    public void setProtocoll(Protocoll p) {
        this.p = p;
    }
