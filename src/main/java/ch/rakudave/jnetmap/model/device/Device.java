...
public interface Device extends Comparable<Device> {
     ...
     * @return the Layer
     */
    String getLayer(); // String helyett Layer? Legyen. MÉgse
    ...
    /**
     * Set the layer number of this device
     *
     * @param layer number
     */
     ...
     * @param isLayer
     */
    void setisLayer(boolean isLayer);

     /**
     * @return if this "device" represaents as layer.
     */
    boolean isLayer();
    ...
    /**
     * Ha layer, akkor mely eszközhöz tartozik?
     */
    String getBelongsTo();

    /**
     * Ha layer, akkor mely eszközjöz tartozik?
     *
     * @param d
     */
    void setBelongsTo(String d);
}