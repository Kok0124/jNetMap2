        ...
        if (checkModifiers(e)) {
            ...
            if (pickSupport != null) {
                ...
                if (vertex != null && startVertex != null &&
                    vertex.isLayer() == startVertex.isLayer()) {
                    ...
                    if (startVertex.equals(vertex)) {
                        if (startVertex.isLayer()) {
                            JOptionPane.showMessageDialog(owner,
                            "No self loop with layers!",
                            "Inane error",
                    ...
                    /* else if (graph.findEdge(startVertex, vertex) != null && vertex.isLayer()) {
                        JOptionPane.showMessageDialog(owner,
                            "Already connceted",
                            "Inane error",
                            JOptionPane.ERROR_MESSAGE);
                    ...
                    vv.repaint();
                        ...
                        vertex.isLayer() != startVertex.isLayer()) {
                            ...
                            JOptionPane.showMessageDialog(owner,
                            "No connection between device and layer!",
                            "Inane error",
                            JOptionPane.ERROR_MESSAGE);
